...
class PPO(Base):
    ...
    def _environment_steps_scan(self, params, graphs, energy_graph_batch, T, key, mode):
        ...
        energy_rewards = jnp.zeros((overall_diffusion_steps , n_graphs, X_prev.shape[1]), dtype=jnp.float32)
        ...
        energy_rewards_per_step = scan_dict["energy_rewards"]
        ...
        log_dict = {"RL": {"states": Xs_over_different_steps[0:-1], "rand_node_features": rand_node_features_diff_steps,
                    ...
                    "Losses": {"reverse_KL": reverse_KL, "noise_rewards": jnp.mean(jnp.sum(noise_rewards[0:, :-1], axis=0)),
